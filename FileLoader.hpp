...
public:
	...
	void ReadFile(const std::string& name, void (**function)(std::vector<std::string>*), int fNums) const
	{
...
private:
	std::string nextStringToCharacter(std::string org, char comp, int startPoint) const
	{
	...
	bool changeSection(std::string line) const
	{
